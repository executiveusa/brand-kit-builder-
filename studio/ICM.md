...
Schema: `studio/schemas/context-packet.v1.json`
...
G2–G4 failures route back with a retry work order (max 3 retries, then escalate model tier per AUTO_ROUTER, then escalate to human).
