...
|---|----------|----------|-------------------------------|
| 1 | **AI slop**: generic gradients, default shadows, emoji icons, bento grids, lorem ipsum | Master Prompt anti-slop list; Gemini "Shadcn visual fatigue" discussion | Models regress to the average of the web | `studio/_system/guardians/GUARDIANS.md` — release-blocking validator packs; taste encoded as rules, not vibes |
...
| 4 | **Wrong-model spend** | auto-router discussion | No routing layer | `studio/_system/routing/AUTO_ROUTER.md` — cheapest model that clears the quality floor, escalate on failure |
...
| 10 | **Scope creep** — building advanced media before one paid loop | architecture pass RISKS list | No sequencing law | `studio/_system/contracts/FACTORY.md` Phase 0: one paid end-to-end loop beats ten architecture expansions |
