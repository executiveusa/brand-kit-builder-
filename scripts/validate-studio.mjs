...
const files = [
  ...
  'apps/studio/export-package.js', 'apps/studio/zip-store.js', 'apps/studio/contracts.js', 'apps/studio/rules-engine.js', 'apps/studio/design-intelligence.js', 'apps/studio/README.md', 'scripts/serve-studio.mjs', 'docs/UPSTREAM_OPEN_CODESIGN.md', 'THIRD_PARTY_NOTICES.md'
];
