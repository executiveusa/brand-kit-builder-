...
const files = [
  ...
  'apps/studio/export-package.js', 'apps/studio/zip-store.js', 'apps/studio/README.md', 'scripts/serve-studio.mjs', 'docs/UPSTREAM_OPEN_CODESIGN.md', 'THIRD_PARTY_NOTICES.md'
];
